                        ...
                        <tr>
                            ...
                            <td class="remove">
                                <form method='post' action=''>
                                    ...
                                    <button type='submit' class='btn btn-link' style="color: #8d1fea">Remove</i></button>
                                </form>
                            </td>
...
<?php
}else{ echo "<h3 class='text-center mt-70 ml-50' style='color:#8d1fea '>Your cart is empty!</h3>
";
}?>
