...
class Dienst extends Db_object
{
    protected static $db_table = "diensten";
    protected static $db_table_fields = array('id', 'title', 'foto','type', 'size');
    ...
    public $tmp_path;
    public $upload_directory = 'img'.DS.'diensten';
    public $errors = array();
    ...
    public function set_dienst_file($file)
    {
